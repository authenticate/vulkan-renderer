...
VkResult ImguiOverlay::prepareResources() {
    ...
    std::vector<VkDescriptorPoolSize> poolSizes = {
        wrapper::make_info<VkDescriptorPoolSize>(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1)};

    VkDescriptorPoolCreateInfo descriptorPoolInfo = wrapper::make_info<VkDescriptorPoolCreateInfo>(poolSizes, 2);
    ...
    std::vector<VkDescriptorSetLayoutBinding> setLayoutBindings = {
        wrapper::make_info<VkDescriptorSetLayoutBinding>(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                                                         VK_SHADER_STAGE_FRAGMENT_BIT, 0),
    };

    VkDescriptorSetLayoutCreateInfo descriptorLayout =
        wrapper::make_info<VkDescriptorSetLayoutCreateInfo>(setLayoutBindings);
    ...
    VkDescriptorSetAllocateInfo allocInfo =
        wrapper::make_info<VkDescriptorSetAllocateInfo>(descriptorPool, &descriptorSetLayout, 1);
    ...
    VkDescriptorImageInfo fontDescriptor = wrapper::make_info<VkDescriptorImageInfo>(
        imgui_texture->get_sampler(), imgui_texture->get_image_view(), VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);

    std::vector<VkWriteDescriptorSet> writeDescriptorSets = {wrapper::make_info<VkWriteDescriptorSet>(
...
VkResult ImguiOverlay::preparePipeline(const VkPipelineCache pipelineCache, const VkRenderPass renderPass) {
    ...
    VkPushConstantRange pushConstantRange =
        wrapper::make_info<VkPushConstantRange>(VK_SHADER_STAGE_VERTEX_BIT, sizeof(PushConstBlock), 0);
    VkPipelineLayoutCreateInfo pipelineLayoutCreateInfo =
        wrapper::make_info<VkPipelineLayoutCreateInfo>(&descriptorSetLayout, 1);
    ...
    VkPipelineInputAssemblyStateCreateInfo inputAssemblyState =
        wrapper::make_info<VkPipelineInputAssemblyStateCreateInfo>(VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST, 0, VK_FALSE);

    VkPipelineRasterizationStateCreateInfo rasterizationState =
        wrapper::make_info<VkPipelineRasterizationStateCreateInfo>(VK_POLYGON_MODE_FILL, VK_CULL_MODE_NONE,
    ...
    VkPipelineColorBlendStateCreateInfo colorBlendState =
        wrapper::make_info<VkPipelineColorBlendStateCreateInfo>(1, &blendAttachmentState);

    VkPipelineDepthStencilStateCreateInfo depthStencilState =
        wrapper::make_info<VkPipelineDepthStencilStateCreateInfo>(VK_FALSE, VK_FALSE, VK_COMPARE_OP_ALWAYS);

    VkPipelineViewportStateCreateInfo viewportState = wrapper::make_info<VkPipelineViewportStateCreateInfo>(1, 1, 0);

    VkPipelineMultisampleStateCreateInfo multisampleState =
        wrapper::make_info<VkPipelineMultisampleStateCreateInfo>(rasterizationSamples);

    std::vector<VkDynamicState> dynamicStateEnables = {VK_DYNAMIC_STATE_VIEWPORT, VK_DYNAMIC_STATE_SCISSOR};
    VkPipelineDynamicStateCreateInfo dynamicState =
        wrapper::make_info<VkPipelineDynamicStateCreateInfo>(dynamicStateEnables);

    VkGraphicsPipelineCreateInfo pipelineCreateInfo =
        wrapper::make_info<VkGraphicsPipelineCreateInfo>(pipelineLayout, renderPass);
    ...
    std::vector<VkVertexInputBindingDescription> vertexInputBindings = {
        wrapper::make_info<VkVertexInputBindingDescription>(0, sizeof(ImDrawVert), VK_VERTEX_INPUT_RATE_VERTEX),
    };
    std::vector<VkVertexInputAttributeDescription> vertexInputAttributes = {
        wrapper::make_info<VkVertexInputAttributeDescription>(0, 0, VK_FORMAT_R32G32_SFLOAT,
                                                              offsetof(ImDrawVert, pos)), // Location 0: Position
        wrapper::make_info<VkVertexInputAttributeDescription>(0, 1, VK_FORMAT_R32G32_SFLOAT,
                                                              offsetof(ImDrawVert, uv)), // Location 1: UV
        wrapper::make_info<VkVertexInputAttributeDescription>(0, 2, VK_FORMAT_R8G8B8A8_UNORM,
                                                              offsetof(ImDrawVert, col)), // Location 0: Color
    };
    VkPipelineVertexInputStateCreateInfo vertexInputState = wrapper::make_info<VkPipelineVertexInputStateCreateInfo>();
