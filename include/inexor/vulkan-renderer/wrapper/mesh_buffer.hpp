...
public:
    ...
    MeshBuffer(const VkDevice device, const VkQueue data_transfer_queue,
    ...
    ///
    ///
    void update_vertices(const void *source, const std::size_t vertex_struct_size, const std::size_t vertex_count,
    ...
    ///
    ///
    void update_indices(const void *source, const std::size_t index_structure_size, const std::size_t index_count,
