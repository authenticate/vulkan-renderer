...
public:
    ...
    [[nodiscard]] VkBuffer get_index_buffer() const {
        ...
        return index_buffer.value().buffer();
    }
    ...
    [[nodiscard]] const std::uint32_t get_index_count() const {
        return number_of_indices;
    }

    [[nodiscard]] auto get_vertex_buffer_address() const {
        return vertex_buffer.allocation_info().pMappedData;
    }
    ...
    [[nodiscard]] auto get_index_buffer_address() const {
        ...
        return index_buffer.value().allocation_info().pMappedData;
    }
